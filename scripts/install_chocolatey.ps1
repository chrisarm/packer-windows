...
$packageRepo = 'https://apps.csci.com/repository/chocolatey'
...
$repoUsername = 'csci-client'
$repoPassword = '{{ REPLACE_REPO_PASSWORD }}'
...
#$unzipMethod = 'builtin'
$unzipMethod = '7zip'
$7zipUrl = 'https://csci-printdrivers.s3-us-west-2.amazonaws.com/7za.exe'
